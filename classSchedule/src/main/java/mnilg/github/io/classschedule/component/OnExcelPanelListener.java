...
public interface OnExcelPanelListener {
    ...
    /**
     * use to record the height of the left header
     * @param holder
     * @param position
     */
    void onAfterBindLeft(RecyclerView.ViewHolder holder,int position);

    /**
     * use to record the height of the normal cell
     * @param holder
     * @param positionX
     * @param positionY
     */
    void onAfterBindNormal(RecyclerView.ViewHolder holder,int positionX,int positionY);
}

...
//        super.setData(data == null ? null : data);
//        if (data != null) {
...
//        contentRecyclerAdapter.setData(list);
        contentRecyclerAdapter.setData((List) getItem(position));
        ...
        ClassScheduleExcelPanel.fastScrollVerticalNormal(amountAxisY, viewHolder.recyclerView,position);
    }
    ...
    static class ContentRecyclerAdapter<C> extends RecyclerViewAdapter<C> {
        ...
        public int getItemViewType(int position) {
            ...
            if(viewType == TYPE_NORMAL){
                viewType = excelPanelListener.getCellItemViewType(verticalPosition, position);
            }
            return viewType;
        }
        ...
        public void onBindNormalViewHolder(RecyclerView.ViewHolder holder, int position) {
            if (excelPanelListener != null) {
                excelPanelListener.onBindCellViewHolder(holder, verticalPosition, position);
                //use to adjust height
                holder.itemView.setTag(ClassScheduleExcelPanel.TAG_KEY, new Pair<>(verticalPosition, position));
                excelPanelListener.onAfterBindNormal(holder, verticalPosition,position);
            }
        }
    }
